   ...
   "userTreatments": [
       {
           ...
           "rank": "1",
           "treatmentType": "In App Content Card",
...
| surface | string | Required | A client configured parameter to request treatments for a particular UI component or screen (home screen) or use case (coupon). A typical example of surface is "Home Screen" or "Purchase Screen".|
